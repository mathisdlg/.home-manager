...
in
{
  options.services.files.default = mkOption {
    type = types.enum [
      "nautilus"
      "dolphin"
      "thunar"
  ...
  config = {
    ...
    # rather than services.files.${cfg.default}.enable = mkForce true; —
    ...
    services.files.nautilus.enable = mkIf (cfg.default == "nautilus") (mkForce true);
    services.files.dolphin.enable = mkIf (cfg.default == "dolphin") (mkForce true);
    services.files.thunar.enable = mkIf (cfg.default == "thunar") (mkForce true);
  };
}
